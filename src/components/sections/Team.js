...
const Team = () => {
  return (
    <Section id="team">
      ...
      <Title>Team</Title>
      <Container>
        <MemberComponent img={img} name="SKYBLAZE" position="founder" />
        ...
        />
        <MemberComponent img={img7} name="MONK" position="web3 developer" />
        <MemberComponent img={img8} name="BANANA" position="graphic designer" />
        {/* <MemberComponent img={img9} name="Weirdos" position="founder" />
        <MemberComponent img={img10} name="Weirdos" position="founder" /> */}
      </Container>
    </Section>
  );
};
